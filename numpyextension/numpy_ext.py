...
def Bin2Int(binaryStr_or_np_binaryArray: str):
	...
	Args:
		binaryStr_or_np_binaryArray(str or np.array): '101001' OR np.array([1,0,0,1,0])A binary string representation of an integer OR a np.array.
	Returns:
		int: integer
	"""
	try:
...
class Tests:
	...
	def test_normalize():
		print('WARNING: test_normalize not implimented!')
		pass
